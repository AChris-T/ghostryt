...
export default function About() {
  ...
  /*   <div className='mb-32'>  
    ...
    <div className='bg-[#151313] px-8 py-20 mt-24 flex-col lg:flex-row flex lg:justify-between justify-center items-center '>
      ...
      <p className='san text-[#a6a6a6] text-[1.2rem]'>Anyone can ask ChatGPT to "Write an article for me." However, GhostRYT goes 
      above and beyond by giving you a team of AI agents. They brainstorm content ideas, 
      pen viral headlines, craft well written articles, optimize for SEO, and then publish
       directly to your site It's not just 'writing an article', it's automating your whole
        content marketing strategy.
        </p>
        <button className='bg-[#e7492b] rounded-[5px] w-[200px] san text-[1.1rem] font-medium px-3 py-3 mt-4 hover:bg-[#151313]'>Get Started Today</button>
